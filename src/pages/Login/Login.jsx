      ...
      <div className="bg-gray-800 p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <div className="mt-6">
          <button
            ...
            className="w-full flex items-center justify-center px-4 py-2 bg-gray-700 text-white font-semibold rounded-md hover:bg-red-600 transition-colors duration-300"
          >
